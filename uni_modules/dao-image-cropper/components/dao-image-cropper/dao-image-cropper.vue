...
export default {
  ...
  methods: {
    fWindowResize() {
      ...
      this.expWidth &&
        (this.exportWidth =
          this.expWidth.indexOf('rpx') >= 0 ? parseInt(this.expWidth) * this.pxRatio : parseInt(this.expWidth))
      this.expHeight &&
        (this.exportHeight =
